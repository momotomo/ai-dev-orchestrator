...
# ---------------------------------------------------------------------------
# Stability-first preamble — single source of truth.
# This block is prepended before the prompt title in every Copilot-facing
# generated prompt.  Do NOT duplicate this text at individual call sites.
# ---------------------------------------------------------------------------
